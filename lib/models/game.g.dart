...
Filters _$FiltersFromJson(Map<String, dynamic> json) {
  return Filters(
    years: (json['years'] as List)
        ?.map((e) =>
            e == null ? null : FiltersYear.fromJson(e as Map<String, dynamic>))
        ?.toList(),
  );
}
...
FiltersYear _$FiltersYearFromJson(Map<String, dynamic> json) {
  return FiltersYear(
    ...
    years: (json['years'] as List)
        ?.map((e) =>
            e == null ? null : YearYear.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
YearYear _$YearYearFromJson(Map<String, dynamic> json) {
  return YearYear(
...
Result _$ResultFromJson(Map<String, dynamic> json) {
  return Result(
    ...
    platforms: (json['platforms'] as List)
        ?.map((e) => e == null
            ? null
            : PlatformElement.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    ...
    tags: (json['tags'] as List)
        ?.map(
            (e) => e == null ? null : Genre.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    shortScreenshots: (json['shortScreenshots'] as List)
        ?.map((e) => e == null
            ? null
            : ShortScreenshot.fromJson(e as Map<String, dynamic>))
        ?.toList(),
  );
}
...
PlatformElement _$PlatformElementFromJson(Map<String, dynamic> json) {
  return PlatformElement(
    ...
    requirementsEn: json['requirementsEn'] == null
        ? null
        : Requirements.fromJson(json['requirementsEn'] as Map<String, dynamic>),
    requirementsRu: json['requirementsRu'] == null
        ? null
        : Requirements.fromJson(json['requirementsRu'] as Map<String, dynamic>),
  );
}
