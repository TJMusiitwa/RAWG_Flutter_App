...
class HttpService {
  ...
  Future<dynamic> getCreators() async {
    http.Response creatorResponse = await http.get(Uri.parse("$rawgAPIURL/creators"),
  ...
  Future<dynamic> getPlatforms() async {
    http.Response platformResponse = await http.get(Uri.parse("$rawgAPIURL/platforms"),
        headers: {HttpHeaders.userAgentHeader: appUserAgent});
  ...
  Future<dynamic> getPublishers() async {
    http.Response publisherResponse = await http.get(Uri.parse("$rawgAPIURL/publishers"),
        headers: {HttpHeaders.userAgentHeader: appUserAgent});
  ...
  Future<dynamic> getStores() async {
    http.Response storeResponse = await http.get(Uri.parse("$rawgAPIURL/stores"),
        headers: {HttpHeaders.userAgentHeader: appUserAgent});
