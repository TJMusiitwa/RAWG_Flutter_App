...
class GenresApi {
  ...
  ///
  ///
  Future<InlineResponse2008> genresList(
  ...
  ///
  ///
  Future<GenreSingle> genresRead(int id) async {
    Object postBody = null;
    ...
    if (response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'GenreSingle') as GenreSingle;
    } else {
      return null;
    }
  }
